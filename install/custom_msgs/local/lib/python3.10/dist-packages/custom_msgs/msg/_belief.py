...
class Metaclass_Belief(type):
    """Metaclass of message 'Belief'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.Belief')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__belief
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__belief
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__belief
            cls._TYPE_SUPPORT = module.type_support_msg__msg__belief
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__belief
...
class Belief(metaclass=Metaclass_Belief):
    """Message class 'Belief'."""
    ...
    def mu(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'mu' field must be a sub message of type 'Pose2D'"
        self._mu = value
